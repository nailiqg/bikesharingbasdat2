...
<link href="<?php echo base_url(); ?>assets/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-ggOyR0iXCbMQv3Xipma34MD+dH/1fQ784/j6cY/iJTQUOhcWr7x9JvoRxT2MZw1T" crossorigin="anonymous">
  ...
  <body class="bg-light">
    ...
    <?php echo form_open('acara/update'); ?>
    <div class="container">
    <div class="col-md-8 ">
    	<br>
    	 <h3>Update Data Acara</h3>
    <p class="lead">Hai Admin, Silahkan Isi Form di bawah ini.</p>
      <form class="needs-validation" novalidate>
        <div class="row">
          <div class="col-md-3 mb-3">
            <label for="firstName">Id Acara</label>
            <input type="text" class="form-control" name="id_acara" placeholder="" value="<?php echo $record['id_acara'] ?>" required>
         ...
         <div class="mb-3">
            <label for="lastName">Judul Acara</label>
            <input type="text" class="form-control" name="judul" placeholder="" value="<?php echo $record['judul'] ?>" required>
            <div class="invalid-feedback">
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control" name="deskripsi" placeholder="" value="<?php echo $record['deskripsi'] ?>" required>
            <div class="invalid-feedback">
              Valid last name is required.
            </div>
          </div>
          ...
          <div class="col-md-3 mb-3">
            ...
            <input type="text" class="form-control" name="tgl_mulai" placeholder="" value="<?php echo $record['tgl_mulai'] ?>" required>
            <div class="invalid-feedback">
              Valid Id is required.
            </div>
          </div>
           <div class="col-md-3 mb-3">
            ...
            <input type="text" class="form-control" name="tgl_akhir" placeholder="" value="<?php echo $record['tgl_akhir'] ?>" required>
            <div class="invalid-feedback">
              Valid Id is required.
            </div>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-md-3 mb-3">
            <?php echo anchor('acara','Batal', array('class'=>'btn btn-warning btn-lg btn-block'));?> 
          </div>
        </div>
      </form>
    </div>
