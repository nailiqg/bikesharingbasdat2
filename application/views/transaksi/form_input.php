      ...
      <form class="needs-validation" novalidate>
        ...
        <div class="row">
          <div class="col-md-3 mb-4">
            ...
            <input type="text" class="form-control" name="nominal" placeholder="" value="" required>
        ...
        <div class="row">
        	...
        	<div class="col-md-3 mb-3">
        		<?php echo anchor('transaksi','Batal', array('class'=>'btn btn-warning btn-lg btn-block'));?> 
        	</div>
        </div>
      </form>
    </div>
