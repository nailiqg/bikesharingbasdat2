      ...
      <form class="needs-validation" novalidate>
        ...
        <div class="row">
          <div class="col-md-5 mb-3">
            ...
            <select class="custom-select d-block w-100" name="petugas" >
              <option>Choose..</option>
              <?php foreach ($ktp as $k) {
                echo "<option value='$k->ktp'";
                echo $record['ktp']==$k->ktp?'selected':'';
                echo ">$k->ktp-$k->nama</option>";
          ...
          <div class="col-md-4 mb-3">
            ...
            <input type="text" class="form-control" name="tgl_mulai" placeholder="" value="<?php echo $record['start_datetime']; ?>" >
            
          </div>
           <div class="col-md-4 mb-3">
            <label for="firstName">Tanggal Berakhir</label>
            <input type="text" class="form-control" name="tgl_akhir" placeholder="" value="<?php echo $record['end_datetime'] ?>" required>
            <div class="invalid-feedback">
