...
<link href="<?php echo base_url(); ?>assets/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-ggOyR0iXCbMQv3Xipma34MD+dH/1fQ784/j6cY/iJTQUOhcWr7x9JvoRxT2MZw1T" crossorigin="anonymous">
  ...
  <body class="bg-light">
    ...
    <div class="col-md-8 ">
    	<br>
    	 <h3>ADD Data peminjaman</h3>
    <p class="lead">Hai Member, Silahkan Isi Form di bawah ini.</p>
      <form class="needs-validation" novalidate>
          
          <div class="row">
            <div class="col-md-5 mb-3">
            <label for="country">Sepeda</label>
            <select class="custom-select d-block w-100" name="sepeda" required>
              <option>Choose..</option>
              <?php foreach ($nomor as $k) {
                 echo "<option value='$k->nomor'>$k->jenis- $k->nama_stasiun</option>"; 
              } ?>
            </select>
        ...
        <div class="row">
        	...
        	<div class="col-md-3 mb-3">
        		<?php echo anchor('peminjaman','Batal', array('class'=>'btn btn-warning btn-lg btn-block'));?> 
        	</div>
        </div>
      </form>
    </div>
