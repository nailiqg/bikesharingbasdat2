...
<link href="<?php echo base_url(); ?>assets/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-ggOyR0iXCbMQv3Xipma34MD+dH/1fQ784/j6cY/iJTQUOhcWr7x9JvoRxT2MZw1T" crossorigin="anonymous">
  ...
  <body class="bg-light">
    ...
    <div class="col-md-8 ">
    	<br>
    	 <h3>Update Data Stasiun</h3>
    <p class="lead">Hai Admin, Silahkan Isi Form di bawah ini.</p>
      <form class="needs-validation" novalidate>

        <div class="col-md-4 mb-3">
            <label for="nama">Nama Stasiun</label>
            <input type="text" class="form-control" name="nama" placeholder="" value="<?php echo $record['nama']; ?>" required>
          ...
          <div class="col-md-10 mb-3">
            ...
            <input type="text" class="form-control" name="alamat" placeholder="" value="<?php echo $record['alamat']; ?>" required>
            <div class="invalid-feedback">
              Valid last name is required.
            </div>
          </div>
          ...
          <div class="col-md-3 mb-3">
            ...
            <input type="text" class="form-control" name="lat" placeholder="" value="<?php echo $record['lat']; ?>" required>
            <div class="invalid-feedback">
              Valid last name is required.
            </div>
          </div>
          <div class="col-md-3 mb-3">
            ...
            <input type="text" class="form-control" name="long" placeholder="" value="<?php echo $record['long']; ?>" required>
            <div class="invalid-feedback">
              Valid last name is required.
            </div>
          </div>
