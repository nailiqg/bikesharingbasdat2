...
<link href="<?php echo base_url(); ?>assets/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-ggOyR0iXCbMQv3Xipma34MD+dH/1fQ784/j6cY/iJTQUOhcWr7x9JvoRxT2MZw1T" crossorigin="anonymous">
  ...
  <body class="bg-light">
    ...
    <div class="col-md-8 ">
    	<br>
    	 <h3>Update Data Voucher</h3>
    <p class="lead">Hai Admin, Silahkan Isi Form di bawah ini.</p>
      <form class="needs-validation" novalidate>

        <div class="mb-3">
            <label for="nama">Nama Voucher</label>
            <input type="text" class="form-control" name="nama" placeholder="" value="<?php echo $record['nama_voucher']; ?>" required>
          ...
          <div class="row">
            ...
            <input type="text" class="form-control" name="kategori" placeholder="" value="<?php echo $record['kategori']; ?>" required>
            <div class="invalid-feedback">
              Valid last name is required.
            </div>
          </div>
          ...
          <div class="row">
            ...
            <input type="text" class="form-control" name="nilai_poin" placeholder="" value="<?php echo $record['nilai_poin']; ?>" required>
            <div class="invalid-feedback">
              Valid last name is required.
            </div>
          </div>
        ...
        <div class="row">
        	...
        	<div class="col-md-3 mb-3">
        		<?php echo anchor('voucher','Batal', array('class'=>'btn btn-warning btn-lg btn-block'));?> 
        	</div>
        </div>
      </form>
    </div>
