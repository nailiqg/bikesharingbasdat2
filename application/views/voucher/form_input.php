      ...
      <form class="needs-validation" novalidate>
        ...
        <div class="mb-3">
          ...
          <div class="row">
            ...
            <input type="text" class="form-control" name="kategori" placeholder="" value="" required>
            <div class="invalid-feedback">
              Valid last name is required.
            </div>
          </div>
          ...
          <div class="row">
            ...
            <input type="text" class="form-control" name="nilai_poin" placeholder="" value="" required>
            <div class="invalid-feedback">
              Valid last name is required.
            </div>
          </div>
            ...
            <input type="text" class="form-control" name="deskripsi" placeholder="" value="" required>
            <div class="invalid-feedback">
              Valid last name is required.
            </div>
