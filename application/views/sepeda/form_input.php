      ...
      <form class="needs-validation" novalidate>
        ...
        <div class="mb-3">
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control" name="jenis" placeholder="" value="" required>
            <div class="invalid-feedback">
              Valid last name is required.
            </div>
          </div>
          ...
          <div class="row">
            ...
            <select class="custom-select d-block w-100" name="nama_penyumbang" required>
              ...
              <?php foreach ($nomor as $k) {
                echo "<option value='$k->no_kartu_penyumbang'>$k->nama_penyumbang</option>";
              } ?>
            </select>
            <div class="invalid-feedback">
              Please select a valid country.
