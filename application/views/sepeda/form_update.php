...
<link href="<?php echo base_url(); ?>assets/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-ggOyR0iXCbMQv3Xipma34MD+dH/1fQ784/j6cY/iJTQUOhcWr7x9JvoRxT2MZw1T" crossorigin="anonymous">
  ...
  <body class="bg-light">
    ...
    <div class="col-md-8 ">
    	<br>
    	 <h3>Update Data Sepeda</h3>
    <p class="lead">Hai Admin, Silahkan Isi Form di bawah ini.</p>
      <form class="needs-validation" novalidate>

        <div class="mb-3">
            <label for="merk">Merk Sepeda</label>
            <input type="text" class="form-control" name="merk" placeholder="" value="<?php echo $record['merk']; ?>" required>
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control" name="jenis" placeholder="" value="<?php echo $record['jenis']; ?>" required>
            <div class="invalid-feedback">
              Valid last name is required.
            </div>
          </div>
        ...
        <div class="row">
          <div class="col-md-5 mb-3">
            <label for="country">Status Sepeda</label>
            <select class="custom-select d-block w-100" name="" required>
          ...
          <div class="col-md-5 mb-3">
            ...
            <select class="custom-select d-block w-100" name="stasiun" required>
              ...
              <?php foreach ($nama as $k) {
                echo "<option value='$k->id_stasiun'";
                echo $record['id_stasiun']==$k->id_stasiun?'selected':'';
                echo ">$k->nama</option>";
              } ?>
            </select>
            <div class="invalid-feedback">
        ...
        <div class="row">
          <div class="col-md-5 mb-3">
            <label for="country">Penyumbang</label>
            <select class="custom-select d-block w-100" name="nama_penyumbang" required>
              <option>Choose..</option>
              <?php foreach ($nomor as $k) {
                echo "<option value='$k->no_kartu_penyumbang'";
                echo $record['no_kartu_penyumbang']==$k->no_kartu_penyumbang?'selected':'';
                echo ">$k->nama_penyumbang</option>";
              } ?>
            </select>
            <div class="invalid-feedback">
              Please select a valid country.
        ...
        <div class="row">
        	...
        	<div class="col-md-3 mb-3">
        		<?php echo anchor('sepeda','Batal', array('class'=>'btn btn-warning btn-lg btn-block'));?> 
        	</div>
        </div>
      </form>
    </div>
